        ...
        <div class="card-content">
            ...
            <ul class="content">
                <li
                    ...
                    @focusout="updated"
                    v-model="addressLines.address_1"
                >
                    {{ address.address_1 }}
                </li>
                <li
                    ...
                    contenteditable="true"
                    @focusout="updated"
                    v-model="addressLines.address_2"
                >
                    {{ address.address_2 }}
                </li>
                <li
                    ...
                    contenteditable="true"
                    @focusout="updated"
                    v-model="addressLines.country"
                >
                    {{ JSON.parse(address.country) }}
                </li>
                <li
                    name="state"
                    contenteditable="true"
                    @focusout="updated"
                    v-model="addressLines.state"
                >
                    {{ address.state }}
                </li>
                <li
