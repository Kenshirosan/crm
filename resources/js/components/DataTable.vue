...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            refreshUpdated() {
                return (this.updated_at = this.contact.updated_at
                    ? moment(this.contact.updated_at).fromNow()
                    : '');
            },
...
<style scoped>
    ...
    tr.is-active:nth-child(even) button:not(.edit) {
        transform: skew(-15deg);
    }

    tr.is-active:nth-child(odd) div,
    tr.is-active:nth-child(odd) button:not(.edit) {
        transform: skew(15deg);
    }
</style>
